...
fn main() {
    ...
    /*let program = &[0x6c, 0x10, 0x01];
    cpu.bus.data[0x0110] = 0x20;
    cpu.bus.data[0x0111] = 0x01;
    cpu.bus.data[0x0120] = 0xa9;
    cpu.bus.data[0x0121] = 0xff;*/

    //let program = &[0xa9, 0xf1, 0xc9, 0xf1, 0xa2, 0xff];
